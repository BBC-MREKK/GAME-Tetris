...
class TestTetris(unittest.TestCase):
    def test_game_over(self): # класс для проверки завершении игры
        tetris = Tetris() # создание класса Tetris
        self.assertFalse(tetris.is_game_over()) # для того чтобы убедиться что игра не завершится в начале
